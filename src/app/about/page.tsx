...
export const metadata: Metadata = {
  title: "About Us | Defense Security Systems",
  description:
    "Established in 2016 in Kollam. Learn about Defense Security Systems, our story, mission, and dedicated CCTV solutions for homes, businesses, and institutions.",
};
