  ...
  return (
    <section className="py-20 md:py-28 bg-white relative overflow-hidden">
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <MotionFadeIn delay={0.1} distance={20}>
          <div className="rounded-3xl bg-[#06221a] text-white p-8 sm:p-12 lg:p-16 relative overflow-hidden shadow-2xl border border-[#00C689]/30">
            ...
            <div className="max-w-3xl space-y-6 relative z-10">
              ...
              <div className="flex flex-col sm:flex-row items-stretch sm:items-center gap-4 pt-4">
                <Link
                  href="/contact"
                  className="inline-flex items-center justify-center gap-2 px-8 py-4 rounded-full text-sm font-bold bg-[#00C689] text-[#06221a] hover:bg-[#008D62] hover:text-white transition-all duration-300 shadow-md active:scale-95 shine-btn hover:-translate-y-0.5"
                >
                ...
                <a
                  ...
                  className="inline-flex items-center justify-center gap-2 px-6 py-4 rounded-full text-sm font-semibold bg-white/10 hover:bg-white/20 text-white border border-white/20 transition-all duration-300 hover:-translate-y-0.5"
                >
